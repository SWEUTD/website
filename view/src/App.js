    ...
    <MuiThemeProvider theme={theme}>
      <BrowserRouter>
          <Switch>
              ...
              <PropsRoute exact path="/test" eventHeading="Sign in to the test" eventPoints={0} eventName = "Match Night 6" eventDate = "11/17/2020" secretWord = "competition" component={meetingform}/>
