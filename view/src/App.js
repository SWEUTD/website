    ...
    <MuiThemeProvider theme={theme}>
      <BrowserRouter>
        <Switch>
          ...
          <PropsRoute exact path="/pi" eventHeading="Sign in to Pi Day Social" eventPoints={1} eventName = "Pi Day Social" eventDate = "3/14/2021" secretWord = "sweet" component={meetingform}/>
        </Switch>
      </BrowserRouter>
    </MuiThemeProvider>
  );
