    ...
    <MuiThemeProvider theme={theme}>
      <BrowserRouter>
          <Switch>
              ...
              <PropsRoute exact path="/test" eventHeading="Sign in to the test" eventPoints={0} eventName = "test" eventDate = "10/22/2020" secretWord = "imposter" component={meetingform}/>
          </Switch>
      </BrowserRouter>
    </MuiThemeProvider>
  );
