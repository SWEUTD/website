    ...
    <MuiThemeProvider theme={theme}>
      <BrowserRouter>
        <Switch>
          ...
          <PropsRoute exact path="/kickoff" eventHeading="Sign in to the SWE Kickoff event" eventPoints={1} eventName = "SWE Kickoff" eventDate = "1/25/2021" secretWord = "points" component={meetingform}/>
        </Switch>
      </BrowserRouter>
    </MuiThemeProvider>
  );
