    ...
    <MuiThemeProvider theme={theme}>
      <BrowserRouter>
          <Switch>
              ...
              <PropsRoute exact path="/kickoff" eventHeading="Sign in to the SWE Kickoff" eventPoints={1} eventName = "SWE Kickoff" eventDate = "8/31/2020" secretWord = "swester" component={meetingform}/>
          </Switch>
      </BrowserRouter>
    </MuiThemeProvider>
  );
