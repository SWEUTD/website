      ...
      <BrowserRouter>
        <Switch>
          ...
          <PropsRoute
            exact
            path="/match2"
            eventHeading="Sign in to the SWE Match event"
            eventPoints={0}
            eventName="Match Night 2"
            eventDate="10/20/2020"
            secretWord="competition"
          ...
          <PropsRoute
            ...
            eventHeading="Sign in to the SWE Match event"
            eventPoints={0}
            eventName="Match Night 3"
            eventDate="10/27/2020"
            secretWord="competition"
            component={meetingform}
          />
          <PropsRoute
          ...
          <PropsRoute
            ...
            eventHeading="Sign in to the SWE Match event"
            eventPoints={0}
            eventName="Match Night 5"
            eventDate="11/10/2020"
            secretWord="competition"
            component={meetingform}
          />
          <PropsRoute
            ...
            eventHeading="Sign in to the SWE Match event"
            eventPoints={0}
            eventName="Match Night 6"
            eventDate="11/17/2020"
            secretWord="competition"
            component={meetingform}
          />
          <PropsRoute
            exact
            path="/test"
            eventHeading="Sign in to the test"
            eventPoints={0}
            eventName="test"
            eventDate="10/22/2020"
            secretWord="imposter"
            component={meetingform}
          />
        </Switch>
