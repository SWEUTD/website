                ...
                <MediaQuery minDeviceWidth={1224}>
                    <Grid container spacing={2} className={classes.row1}>
                        <Grid item xs={6} className={classes.col}>
                            ...
                            <br/>
                            <p>
                                The UTD SWE stimulates women to achieve full potential in careers as engineers and leaders, 
                        ...
                        <Grid item xs={2} className={classes.linkCol}>
                            ...
                            <ul style={{listStyleType:'none',margin:'10%'}}>
                                <li><a href="/swestars">SWE Stars</a></li>
                                <li><a href="/swematch">SWE  Match</a></li>                     
                            </ul>
                        </Grid>
                    </Grid>
