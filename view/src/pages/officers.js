...
class officers extends Component {
		...
		return (
			<div className={classes.root}>
				...
				<div className="officerHeading" style= {{height: "50px"} ,{padding: "20px"}}>
		            	<h2><center>Board Members</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Board Members").map((officer) => (
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Conference Committee</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Conference Committee").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Industry Committee</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Industry Committee").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Marketing Committee</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Marketing Committee").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Outreach Committee</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Outreach Committee").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Website Development Committee</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Website Development Committee").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
				...
				<Container className={classes.container}>
				<div className="officerHeading" style= {{height: "100px"} ,{padding: "50px 0 20px 0"}}>
		            	<h2><center>Faculty Advisors</center></h2>
                	</div>
					<Grid container
					spacing={5}
					height="100%"
					...
					>
						...
						{officerList.filter(person => person.committee=="Faculty Advisors").map((officer) => (
							<Grid className={classes.gridItem} item xs="6" sm="3">
								<Card className={classes.card} className="movingItem" variant="outlined">	
									<CardContent align="center">
										<img src={officer.image} className={classes.image} />
